...
namespace DigitalWallet.Infrastructure.Migrations
{
    ...
    [Migration("20260303141423_UpdateAccountUniqueIndex")]
    partial class UpdateAccountUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalWallet.Domain.Entities.Account", b =>
                {
                    ...
                    b.HasIndex("UserId", "CurrencyCode", "Type")
                        .IsUnique()
            ...
            modelBuilder.Entity("DigitalWallet.Domain.Entities.KycSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
